  ...
  programs.neovim = {
    ...
    configure = {
      customRC = ''
        ...
        \ {'name': 'coveredby',                   'mathmode': 1, 'concealchar': '⊏'},
        \ {'name': 'covers',                      'mathmode': 1, 'concealchar': '⊐'},
        \ {'name': 'Join',      'cmdre': 'join',  'mathmode': 1, 'concealchar': '⋁'},
        \ {'name': 'Meet',      'cmdre': 'meet',  'mathmode': 1, 'concealchar': '⋀'},
        \ {'name': 'Dots',      'cmdre': 'dots(c|o|b|i)=', 'mathmode': 1, 'concealchar': '…'},
        \]
